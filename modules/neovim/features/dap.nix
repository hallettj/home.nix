        ...
        config = /* lua */ ''
          ...
          lze.load {
            ...
            keys = {
              ...
              { '<leader>dC', function() require('dap').clear_breakpoints() vim.notify('breakpoints cleared', vim.log.levels.WARN) end, desc = 'dap: clear breakpoints' },
              -- stylua: ignore end
            },
            on_require = "dap",
            after = function()
          ...
          lze.load {
            ...
            on_require = "dapui",
            after = function() require("dapui").setup {} end,
          }
