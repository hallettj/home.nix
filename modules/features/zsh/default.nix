    ...
    let
      ...
      useOutOfStoreSymlinks =
        if builtins.hasAttr "useOutOfStoreSymlinks" config.home then
          ...
          false;
      dir = "${flakePath}/modules/features/zsh";
    in
    {
      programs.zsh = {
        enable = true;
      ...
      xdg.configFile.zsh = {
        source =
          if useOutOfStoreSymlinks then
            config.lib.file.mkOutOfStoreSymlink "${dir}/home/.config/zsh"
          else
            ./home/.config/zsh;
      };
      ...
      home.file = {
        dircolors = {
          source =
            if useOutOfStoreSymlinks then
              config.lib.file.mkOutOfStoreSymlink "${dir}/home/.dircolors"
            else
              ./home/.dircolors;
          target = ".dircolors";
        };
        inputrc = {
          source =
            if useOutOfStoreSymlinks then
              config.lib.file.mkOutOfStoreSymlink "${dir}/home/.inputrc"
            else
              ./home/.inputrc;
          target = ".inputrc";
        };
