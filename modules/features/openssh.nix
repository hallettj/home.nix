...

{
  flake.modules.nixos.openssh =
    ...
    let
      ...
      myHosts = builtins.listToAttrs (
        builtins.map (host: {
          name = host;
          value = {
            publicKeyFile = pubKey host;
            extraHostNames = [ (host + ".local") ] ++ lib.optional (host == hostName) "localhost";
          };
        }) (builtins.filter (host: builtins.pathExists (pubKey host)) hosts)
      );
      ...
      otherKnownHosts = {
        ...
        "borgbase" = {
          hostNames = [
            "efjn7220.repo.borgbase.com"
            "kd9sk70h.repo.borgbase.com"
            "t5gkkxea.repo.borgbase.com"
          ];
          publicKeys = [
          ...
          //
            ...
            builtins.listToAttrs (
              builtins.concatMap (
                hostId:
                let
                  host = builtins.getAttr hostId otherKnownHosts;
                in
