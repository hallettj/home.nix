...
{
  flake.modules.homeManager.paperwm =
    { config, ... }:
    ...
    in
    {
      imports = [ self.homeModules.paperwm ];
      ...
      gnomeExtensions.paperwm = {
        ...
        winprops = [
          ...
          {
            wm-class = "chrome-cinhimbnkkaeohfgghhklpknlkffjgod-Default";
            scratch-layer = true;
          }
          {
            wm-class = "kitty";
            preferred-width = terminal-width;
          }
          {
            wm-class = "neovide";
            preferred-width = neovide-width;
          }
        ];
        ...
        workspaces = [
          {
            name = "Home";
            id = "f7bf4f04-df01-49d4-90d9-ac80b7e9d3b2";
          }
          {
            name = "Work";
            id = "d13c7071-e870-4014-92a4-709476e62916";
            color = "rgb(73,64,102)";
          }
          {
            name = "IBNU";
            id = "7c060a9f-4e62-40c6-9d78-278d8d959e2c";
          }
          {
            name = "Games";
            id = "e47bab66-3212-415e-bc03-cd4cd6cef712";
          }
        ];
